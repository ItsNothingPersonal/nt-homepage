...
<div class="bg-light-50 dark:bg-dark-700 card w-full p-4 text-left">
	...
	<h1 class="h1 font-bold tracking-tight text-gray-900 dark:text-white">
		{title}
	</h1>

	<p
		class={`[&>h1]:text-3xl [&>h1]:font-bold [&>h2]:text-2xl [&>h2]:font-bold [&>h3]:text-xl [&>h3]:font-bold [&>p]:mb-2 [&>p]:text-justify [&>p]:first-letter:text-2xl ` +
