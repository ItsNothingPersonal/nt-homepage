import { AnarchenAemterName } from '$lib/types/anarchenAemterName';
import { ClanName } from '$lib/types/clanName';
import type { SubMenuConfig } from '$lib/types/subMenuConfig';
import { anarchenCharakter, type AnarchenCharakter } from '$lib/types/zod/anarchenCharaktere';
import { isNullOrUndefined } from '$lib/util';
import { get, type Writable } from 'svelte/store';

export function getClanSubMenu(
	clanFilter: Writable<string | null>,
	charaktere: AnarchenCharakter[]
): SubMenuConfig[] {
...
export function getOfficers(
	...
	return anarchenCharakter
		.array()
		.parse(charaktere)
		.filter((e) => !isNullOrUndefined(e.offizier) && e.offizier.name !== AnarchenAemterName.Baron)
